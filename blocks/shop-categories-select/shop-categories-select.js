...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'starter-shop/shop-categories-select', {
        apiVersion: 2,
        title: 'Shop Categories Select',
        description: '',
        icon: 'block-default',
        category: 'shop',
        keywords: [],
        ...
        example: { attributes: { list: '', title: `Selected categories` } },
        edit: function ( props ) {
                            ...
                            el(Panel, {},
                                el(PanelBody, {
                                    ...
                                    el(TextControl, {
                                        ...
                                        help: __( 'A comma seperated list of category slugs.' ),
                                        label: __( 'List of categories' ),
                                        onChange: function(val) { setAttributes({list: val}) },
                                        type: 'text'
                                    }),
                                    el(TextControl, {
