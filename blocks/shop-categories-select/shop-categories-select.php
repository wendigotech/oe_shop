<div <?php if(empty($_GET['context']) || $_GET['context'] !== 'edit') echo get_block_wrapper_attributes( array() ); else echo 'data-wp-block-props="true"'; ?>>
    <?php $terms = get_terms( array(
            ...
            'orderby' => 'slug__in',
            'order' => 'ASC',
            'slug' => PG_Helper_v2::getArray( PG_Blocks_v3::getAttributeForAction( $args, 'list' ) ),
            'hide_empty' => true
    ) ) ?>
    <section class="bg-dark pb-5 pg-lib-item pt-5">
        <div class="container pb-5 pt-5">
            <h1 class="h2 mb-4 text-white"><?php echo PG_Blocks_v3::getAttribute( $args, 'title' ) ?></h1>
